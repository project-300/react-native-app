...
export const SIGNUP_CONFIRMATION_REQUIRED: string =
  'SIGNUP_CONFIRMATION_REQUIRED';
export const SIGNUP_CONFIRMATION_REQUEST: string =
  'SIGNUP_CONFIRMATION_REQUEST';
export const SIGNUP_CONFIRMATION_SUCCESS: string =
  'SIGNUP_CONFIRMATION_SUCCESS';
export const SIGNUP_CONFIRMATION_FAILURE: string =
...
export const UPDATE_ADD_USER_JOURNEY_REQUEST: string =
  'UPDATE_ADD_USER_JOURNEY_REQUEST';
export const UPDATE_ADD_USER_JOURNEY_SUCCESS: string =
  'UPDATE_ADD_USER_JOURNEY_SUCCESS';
export const UPDATE_ADD_USER_JOURNEY_FAILURE: string =
