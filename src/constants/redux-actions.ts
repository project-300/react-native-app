...
export const FETCHING_LIFTS_REQUEST: string = 'FETCHING_LIFTS_REQUEST';
export const FETCHING_LIFTS_FAILURE: string = 'FETCHING_LIFTS_FAILURE';
export const FETCHING_LIFTS_SUCCESS: string = 'FETCHING_LIFTS_SUCCESS';
